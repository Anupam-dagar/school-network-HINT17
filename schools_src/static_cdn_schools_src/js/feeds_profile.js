$(function () {
  ...
  $(".btn-compose").click(function () {
    if ($(".compose").hasClass("composing")) {
      $(".compose").removeClass("composing");// $('#show7').click(function(){
//   $('.target1').show('scale', {percent:200, direction:'vertical'}, 2000);
// });
// $('#hide7').click(function(){
//   $('.target1').hide('scale', {percent:200, direction:'horizontal'}, 2000);
// });
...
// });
    ...
    $.ajax({
      ...
      success: function (data) {
        if ($(".like", li).hasClass("unlike")) {
          ...
          $(".like .text", li).text("Agree");
          // $(".like .red", li).toggleClass('red');
          // $(".like .red", li).css('color','red');
        }
        else {
          $(".like", li).addClass("unlike");
          $(".like .text", li).text("Disagree");
          // $(".like .green", li).toggleClass('green');
          // $(".like .green", li).css('color','green');
        }
  ...
  // update_feeds();
   ...
   function update_profile_likes () {
    var profile_pk= $("#profile").attr("profile-pk");
      $.ajax({
        url: '/feeds/profile_update/',
        data: {
        ...
        success: function (data) {
          if (parseInt(data) > 0) {
            $("#profile .likes").text(data);
          }
        },
        complete: function() {
          window.setTimeout(update_profile_likes, 30000);
        }
      });
  };
